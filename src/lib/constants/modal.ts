...
// @ts-ignore - ClipboardJS puede no tener tipos disponibles
...
/**
 * Muestra un modal de éxito con la información de la partida creada
 * @param partidaData - Datos de la partida creada por el backend
 * @param formTipo - Tipo de partida del formulario ('publica' o 'privada')
 * @param formCantidad - Cantidad de preguntas del formulario
 * @param formTiempo - Tiempo por pregunta del formulario
 */
