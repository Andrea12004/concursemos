  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-2 px-3 py-1 rounded-md border border-white/30 text-white text-sm w-auto hover:bg-[#f26a2f] hover:border-[#f26a2f] transition-colors"
