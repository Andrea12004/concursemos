...
import { getColumnsCategorias } from "@/lib/constants/categoryColumnsConfig";
import "@/components/categorias/css/styles.css";
import type { Category, CategoriasUser as User, CategoriasAuthResponse as AuthResponse } from '@/lib/types/categorias';
