...
import '@/components/crear-partida/css/styles.css'
...
import Select from '@/components/UI/Select/Select';
 import Carrusel from '@/components/crear-partida/carrusel-crear-partida'; 
 import CategoriaModal from '@/components/modals/modal-category-banco'; 

dayjs.extend(customParseFormat);
dayjs.locale('es');

import type { FormData, AuthResponse, Question, QuestionsByCategory } from '@/lib/types/crear-partida';
